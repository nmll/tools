...
for file in files:  # 遍历文件夹
    ...
    if not os.path.isdir(file):  # 判断是否是文件夹，不是文件夹才打开
        ...
        if len(f.readlines()) >0:
            ...
            f.write('DontCare -1 -1 -10.000000 1217.700000 137.630000 1242.000000 225.790000 -1000.000000 -1000.000000 -1000.000000 -10.000000 -1.000000 -1.000000 -1.000000 -1 -1 -1')
